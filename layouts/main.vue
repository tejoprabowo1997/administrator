...
<template>
  <q-layout view="hHh Lpr lff" container style="height: 100vh" class="bg-blue-1">
    <q-header elevated class="bg-blue-6 text-white">
      <q-toolbar>
        <q-btn dense flat round icon="menu" @click="sideMenu = !sideMenu" />

        <q-toolbar-title> HayoDagang </q-toolbar-title>
          ...
          <q-list>
            ...
            <q-item clickable v-close-popup tabindex="0">
              <q-item-section avatar>
                <q-avatar icon="settings" color="grey-2" text-color="blue-6" />
              </q-item-section>
              <q-item-section>
            ...
            >
              <q-item-section avatar>
                <q-avatar icon="fullscreen" color="grey-2" text-color="blue-6" />
              </q-item-section>
              <q-item-section>
